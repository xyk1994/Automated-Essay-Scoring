...
def get_model():
    ...
    lstm2 = LSTM(32, dropout=0.1, recurrent_dropout=0.1, return_sequences=False)(sent_feature_concat_layer)
...
for train, test in cv.split(essays_pad):
    ...
    model.fit([text_train, overall_train, sent_train], label_train, batch_size=64, epochs=50)
