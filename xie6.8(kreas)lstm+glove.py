...
def get_model():
    ...
    model.add(Bidirectional(LSTM(100, dropout=0.1, recurrent_dropout=0.1, return_sequences=False)))
...
for train, test in cv.split(text_in_index):
    ...
    lstm_model.fit(text_train, label_train, batch_size=64, epochs=50)
