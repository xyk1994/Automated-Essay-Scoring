...
dataframe = pd.read_csv('data/predict_data_set1.tsv', delimiter="\t", engine="python", error_bad_lines=False)
data = dataframe[['essay_set', 'essay', 'domain1_score', 'predict_score']].copy()
# print(data)

feature_names_cv, count_vectors = get_count_vectors(data[data['essay_set'] == 1]['essay'])
X_cv = count_vectors.toarray()
# y_cv = data[data['essay_set'] == 1]['predict_score'].as_matrix()
